...
const extensions = [".js", ".jsx", ".ts", ".tsx", ".cjs", ".mjs", ".mdx", ".d.ts", ".json", "/index.js", "/index.jsx", "/index.ts", "/index.tsx", "/index.cjs", "/index.mjs", "/index.mdx", "/index.d.ts"] as const;
export function convertToAbsolutePath(path: string, paths: Record<string, string[]> | undefined, srcDir = "."): string {
